...
public class ModelViewPagerAdapter extends PagerAdapter {
    ...
    private List<uz.ithelp.idrokfenomenlari.ModelViewPager> modelViewPagerList;
    private LayoutInflater layoutInflater;
    private Context context;

    public ModelViewPagerAdapter(List<uz.ithelp.idrokfenomenlari.ModelViewPager> modelViewPagerList, Context context) {
